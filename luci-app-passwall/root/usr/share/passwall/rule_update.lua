...
local gfwlist_url =  {"https://cdn.jsdelivr.net/gh/Loyalsoldier/v2ray-rules-dat@release/gfw.txt"}
local chnroute_url =  {"https://ispip.clang.cn/all_cn.txt"}
local chnroute6_url =    {"https://ispip.clang.cn/all_cn_ipv6.txt"}
local chnlist_url =  {"https://cdn.jsdelivr.net/gh/felixonmars/dnsmasq-china-list/accelerated-domains.china.conf","https://cdn.jsdelivr.net/gh/felixonmars/dnsmasq-china-list/apple.china.conf","https://cdn.jsdelivr.net/gh/felixonmars/dnsmasq-china-list/google.china.conf"}
