...
o = s:option(Value, "memory_limit", translate("内存最大使用"), translate(
                 "如果你的设备内存较大的话，可以适当增加。"))
o.default = "8M"
o.rmempty = false

o = s:option(Value, "post_max_size", translate("POST最大容量"),
             translate("该值不能大于 内存最大使用"))
o.default = "12M"
o.rmempty = false

o = s:option(Value, "upload_max_filesize",
             translate("上传文件最大使用内存"),
             translate("该值不能大于 POST最大容量"))
o.default = "12M"
o.rmempty = false

o = s:option(Value, "storage_device_path", translate("存储设备路径"),
             translate(
                 "建议插入U盘或硬盘，然后输入路径。例如：/mnt/sda1/"))
o.default = "/mnt/sda1/"
o.rmempty = false

o = s:option(Value, "project_directory", translate("项目存放目录"),
             translate(
                 "建议插入U盘或硬盘，然后输入路径。例如：/mnt/sda1/kodexplorer"))
o.default = "/mnt/sda1/kodexplorer"
o.rmempty = false

o = s:option(Button, "_download", translate("手动下载"), translate(
                 "请确保具有足够的空间。<br /><font style='color:red'>第一次运行务必填好设备路径和存放路径，然后保存应用。再手动下载，否则无法使用！</font>"))
