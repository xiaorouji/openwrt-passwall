...
function e.write(t,section)
	local url=luci.dispatcher.build_url("admin", "vpn", "ssr_python_pro_server", "clear_traffic_all_users")
...
e.inputstyle="remove"
function e.write(t,section)
	local url=luci.dispatcher.build_url("admin", "vpn", "ssr_python_pro_server", "ssr_python_clear_traffic")
