...
function get_kcptun_file_path()
    return uci:get("passwall", "global_kcptun", "kcptun_client_file") or
               luci.sys.exec(
                   "echo -n `uci get passwall.@global_kcptun[0].kcptun_client_file`")
end
...
function to_check(arch)
    ...
    local needs_update = compare_versions(get_kcptun_version(client_file), "<",
                                          remote_version)
