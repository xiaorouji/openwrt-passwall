...
s = m:section(TypedSection, "global", translate("DNS Settings"))
s.anonymous = true
s.addremove = false
o = s:option(Value, "socks_server", translate("Socks Server"), translate("Make sure socks service is available on this address if 'dns2socks' selected."))
o.default = "127.0.0.1:1080"

o = s:option(Flag, "dns_cache", translate("Cache Resolved"))
o.default = "1"

---- Upstream trust DNS Mode for ChinaDNS-NG
o = s:option(Flag, "fair_mode", translate("ChinaDNS-NG Fair Mode"))
o.default = "1"

---- DNS Forward Mode
o = s:option(ListValue, "dns_mode", translate("DNS Hijack"))
o.rmempty = false
o:reset_values()
...
o:value("local_7913", translate("Forward to '127.0.0.1:7913'"))
o:value("nonuse", translate("Trust my ISP"))

o = s:option(Value, "up_china_dns", translate("Resolver For White List Domains") .. "(UDP)")
o.description = translate("Select 'default' to work with other DNS acceleration services<br />IP:Port mode acceptable, two at most if split by english comma.")
o.default = "default"
...
o = s:option(ListValue, "up_trust_chinadns_ng_dns", translate("Resolver For GFW List Domains") .. "(UDP)")
o.default = "pdnsd"
if is_installed("pdnsd") or is_installed("pdnsd-alt") or is_finded("pdnsd") then
    o:value("pdnsd", "pdnsd, " .. translate("Access Trust DNS By ") .. translate("TCP Node"))
end
if is_finded("dns2socks") then
    o:value("dns2socks", "dns2socks")
end
o:value("udp", translate("Access Trust DNS By ") .. translate("UDP Node"))
o:depends("dns_mode", "chinadns-ng")

---- DNS Forward
o = s:option(Value, "dns_forward", translate("Trust DNS"), translate("DNS Service Address.<br />IP:Port mode acceptable, the 1st for 'dns2socks' if split with english comma."))
o.default = "8.8.4.4"
...
for i = 1, udp_node_num, 1 do
    if i == 1 then
        ...
        o.description = translate("For Game Mode or DNS Hijack and more.") .. translate("The selected server will not use Kcptun.")
        o:value("nil", translate("Close"))
