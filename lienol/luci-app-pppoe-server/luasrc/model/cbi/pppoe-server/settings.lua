...
o.rmempty=true
o.default="50"
o=s:option(Value,"dns1",translate("DNS IP address1"),translate("Set the PPPoE server to default DNS server, which is not required."))
o.placeholder=translate("10.0.1.1")
o.datatype="ipaddr"
o.default="10.0.1.1"
o=s:option(Value,"dns2",translate("DNS IP address2"),translate("Set the PPPoE server to default DNS server, which is not required."))
